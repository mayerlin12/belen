<%-- 
    Document   : interfaces
    Created on : 21/09/2021, 12:39:28 PM
    Author     : skand
--%>
<!doctype html>
<html lang="en">
...
<main>
  <h1 class="visually-hidden">Menú</h1>
    ...
    %>
        ...
        <div>
            ...
            <div style="float: right; margin-right: 30%;" >
                <h1>Interfaces</h1>
                <h1>Bienvenido Administrador <% out.print(user);%></h1>
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 190px; height: 645px">
  ...
  <path d="M7.646 15.854a.5.5 0 0 0 .708 0L10.207 14H14a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2H2a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h3.793l1.853 1.854zM1 9V6h14v3H1zm14 1v2a1 1 0 0 1-1 1h-3.793a1 1 0 0 0-.707.293l-1.5 1.5-1.5-1.5A1 1 0 0 0 5.793 13H2a1 1 0 0 1-1-1v-2h14zm0-5H1V3a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v2zM2 11.5a.5.5 0 0 0 .5.5h8a.5.5 0 0 0 0-1h-8a.5.5 0 0 0-.5.5zm0-4a.5.5 0 0 0 .5.5h11a.5.5 0 0 0 0-1h-11a.5.5 0 0 0-.5.5zm0-4a.5.5 0 0 0 .5.5h6a.5.5 0 0 0 0-1h-6a.5.5 0 0 0-.5.5z"/>
    ...
    <a href="index.jsp" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
        <span class="fs-4" style=" text-align: center">Menú</span>
    </a>
    <hr>
...
Inicio
      ...
      <li>
        ...
        <a href="dashboard1.jsp" class="nav-link text-white">
<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-speedometer2" viewBox="0 0 16 16">
 ...
 Dashboard 1 
      ...
      <li>
        ...
        <a href="dashboard2.jsp" class="nav-link text-white">
<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-speedometer" viewBox="0 0 16 16">
  ...
  <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2z"/>
      ...
      <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false" style=" font-size: 15px">
        <strong>
  ...
  <% out.print(user);%>
      ...
      <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser1">
        ...
        <li><a class="dropdown-item" href="index.jsp" style=" font-size: 10px">Cerrar Sesion</a></li>
      </ul>
    </div>
  </div>
